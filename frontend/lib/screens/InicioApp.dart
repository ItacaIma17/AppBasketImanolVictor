          ...
          child: ListView(
            ...
            children: [
              ...
              ...equiposFav.map((nombre) {
                ...
                return _buildChipFavorito(
                    nombre, Icons.sports_basketball, AppColors.rojoAragon,
                        () => Navigator.push(context, MaterialPageRoute(builder: (_) =>
                        EquipoDetallePage(equipo: equipo))));
              }),
              ...jugadoresFav.map((nombre) {
                final jugador = _jugadores.firstWhere(
                      (j) => j.nombreCompleto == nombre,
                  orElse: () => Jugador(
                    id: null,
                    username: '',
                    email: '',
                ...
                return _buildChipFavorito(
                    nombre, Icons.person, Colors.blue.shade400,
                        () => Navigator.push(context, MaterialPageRoute(builder: (_) =>
