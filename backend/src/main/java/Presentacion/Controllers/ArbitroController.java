...
public class ArbitroController {
    ...
    // ============================================================
    // ENDPOINTS PARA EL PROPIO ÁRBITRO
    // ============================================================
    ...
    // ✅ El árbitro confirma las alineaciones de un partido (desbloquea el acta)
    ...
    // ============================================================
    // ENDPOINTS DE ADMINISTRACIÓN (CRUD COMPLETO)
    // ============================================================
    ...
    public ResponseEntity<ArbitroResponse> actualizarArbitro(
        ...
        log.info("✏️ Actualizando árbitro ID: {}", id);
    ...
    public ResponseEntity<Void> eliminarArbitro(@PathVariable Long id) {
        log.info("🗑️ Eliminando árbitro ID: {}", id);
